        ...
        <PageContainer>
            <PageHeader>
                <HeaderTitle>
                    ...
                    <p>Registra la entrada de mercader\u00eda desde proveedores</p>
                </HeaderTitle>
                            ...
                            {orders.length === 0 ? (
                                ...
                                orders.map(o => (
                                    <tr key={o.id}>
                                        ...
                                        <td>{o.fecha_llegada_estimada ? new Date(o.fecha_llegada_estimada).toLocaleDateString() : "-"}</td>
                                        ...
                                        <td style={{ textAlign: "right" }}>
                                            <div style={{ display: "flex", gap: 8, justifyContent: "flex-end" }}>
                                                ...
                                                <ActionBtn onClick={() => handleReceive(o)} title="Recibir Mercader\u00eda" disabled={o.status === 'RECEIVED'}>
                                                    <FiDownload />
                                                </ActionBtn>
                                                <ActionBtn
                                                    $variant="delete"
