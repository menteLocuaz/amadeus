                        ...
                        <div style={{ 
                            ...
                            <div>
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: "8px", fontWeight: 600 }}>
                                    <FiTag color="#FCA311" /> {fullOrder?.numero_orden || order.numero_orden}
                                </div>
                            </div>
                            <div>
                                ...
                                <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
                                    <div style={{ display: "flex", alignItems: "center", gap: "8px", fontWeight: 700, fontSize: "1.05rem" }}>
                                        <FiUser color="#FCA311" /> {fullOrder?.proveedor?.nombre || order.proveedor?.nombre || "N/A"}
                                    </div>
                            ...
                            <div>
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: "8px", fontWeight: 600 }}>
                                    <FiMapPin color="#FCA311" /> {fullOrder?.sucursal?.nombre || "Sucursal Principal"}
                                </div>
                            </div>
                            <div>
                                <small style={{ opacity: 0.6, display: "block", marginBottom: "4px" }}>Fecha Creación</small>
                                <div style={{ display: "flex", alignItems: "center", gap: "8px", fontWeight: 600 }}>
                                    <FiCalendar color="#FCA311" /> {formatDate(fullOrder?.fecha_creacion || order.fecha_creacion)}
                                </div>
                            </div>
                        </div>

                        {fullOrder?.observaciones && (
                            <div style={{ marginBottom: 20, padding: "0 10px", borderLeft: "3px solid #FCA311" }}>
                ...
                <div style={{ background: "rgba(0,0,0,0.02)", padding: 15, borderRadius: 12, marginBottom: 20 }}>
                    ...
                    <div style={{ maxHeight: "300px", overflowY: "auto", marginTop: "10px" }}>
                        {items.map((it, idx) => (
                            <div key={it.id_detalle_compra} style={{ display: "grid", gridTemplateColumns: "3fr 1fr 1fr 1fr 1.5fr", gap: 10, alignItems: "center", padding: "12px 0", borderBottom: "1px solid rgba(0,0,0,0.03)" }}>
                                <div>
                                    <div style={{ fontSize: "1rem", fontWeight: 700, color: "#14213D" }}>{it.nombre}</div>
                                    <div style={{ display: "flex", gap: "8px", marginTop: "2px" }}>
                                        ...
                                        {it.unidad && (
                                            <small style={{ opacity: 0.6, backgroundColor: "rgba(252, 163, 17, 0.1)", color: "#FCA311", padding: "1px 6px", borderRadius: "4px", fontSize: "0.75rem", fontWeight: 600 }}>
                                                {it.unidad}
                                            </small>
                                        )}
                                    </div>
                                ...
                                <div style={{ textAlign: "right" }}>
                                    <input
                                        ...
                                        style={{ 
                                            ...
                                            fontWeight: 600,
                                            transition: "all 0.2s",
                                            backgroundColor: it.cantidad_recibida !== it.cantidad_pedida ? "rgba(252, 163, 17, 0.15)" : "white"
                                        }}
                                ...
                                <div style={{ textAlign: "right", fontWeight: 800, color: "#14213D", fontSize: "1rem" }}>${(Number(it.precio_unitario) * Number(it.cantidad_recibida)).toLocaleString(undefined, { minimumFractionDigits: 2 })}</div>
                            </div>
                        ))}
                    </div>
                    <div style={{ display: "flex", justifyContent: "flex-end", marginTop: "15px", padding: "10px", borderTop: "2px solid rgba(0,0,0,0.05)" }}>
                        <div style={{ textAlign: "right" }}>
                            ...
                            <div style={{ fontSize: "1.2rem", fontWeight: 800, color: "#FCA311" }}>
